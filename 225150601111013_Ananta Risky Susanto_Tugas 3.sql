...
insert into  mahasiswa (NIM,ID_SELEKSI_MASUK,ID_PROGRAM_STUDI,NAMA,ANGKATAN,TGL_LAHIR,KOTA_LAHIR ,JENIS_KELAMIN) values ('155150400',1,211,'JONI',2015,'1997-1-1','Malang','W');
insert into  mahasiswa (NIM,ID_SELEKSI_MASUK,ID_PROGRAM_STUDI,NAMA,ANGKATAN,TGL_LAHIR,KOTA_LAHIR ,JENIS_KELAMIN) values ('155150401',2,212,'JON0',2015,'1997-10-2','Situbondo','P');
